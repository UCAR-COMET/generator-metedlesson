...
{	
	...
	private $toc; //The dom of the current Índice.
	...
	public function getBackNextCode($page)
	{
		...
		if($previous == $page)
		{
			...
			if($this->tab == 1)
			{
				return '<div class="stage_nav"><ul class="pager"><li class="previous invisible"></li><li class="next"><a href="' . $this->linkPrefix . '?tab=' . $this->tab . '&amp;page=' . $next . "&amp;type=" . $this->type . $this->linkSuffix . '">Adelante &rarr;</a></li></ul></div>';
		...
		}else if($next == $page)
		{
			...
			{
				return '<div class="stage_nav"><ul class="pager"><li class="previous"><a href="' . $this->linkPrefix . '?tab=' . $this->tab . '&amp;page=' . $previous . "&amp;type=" . $this->type . $this->linkSuffix . '">&larr; Atrás</a></li><li class="inactive-next"></li></ul></div>';
			}else
			{
		...
		{										 
			return '<div class="stage_nav"><ul class="pager"><li class="previous"><a href="' . $this->linkPrefix . '?tab=' . $this->tab . '&amp;page=' . $previous . "&amp;type=" . $this->type . $this->linkSuffix . '">&larr; Atrás</a></li> <li class="next"><a href="' . $this->linkPrefix . '?tab=' . $this->tab . '&amp;page=' . $next . "&amp;type=" . $this->type . $this->linkSuffix . '">Adelante &rarr;</a></li></ul></div>';								 
		}	
	}
