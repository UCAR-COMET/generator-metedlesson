...
<head>
	...
	$(document).ready(function() {
		...
		$(".media-thumbnail > a[href$='.htm']:even, .media-thumbnail > a[href$='.html']:even, a[href$='.mp4']")
			.attr('rel', 'gallery-anim').fancybox({
				type: 'iframe',
				helpers: {
					title: {
						type: 'inside'
...
<body>
	...
	<main id="master-container" class="container">
					...
					<div id="a<?php echo $item->id; ?>" class="col-md-4 col-xs-6 gallery-item">
						...
						<article class="panel panel-default">
							<section class="media-thumbnail">
								...
								<a href="<?php echo $item->path . "/index." . $item->extension; ?>" target="_blank"><img
										src="<?php echo $item->path . "/" . $item->name . ".jpg" ?>"
										alt="<?php echo $item->description; ?>" height="130" /></a> <br />
								<a href="<?php echo $item->path . "/index." . $item->extension; ?>"
									target="_blank">Regarder l'animation</a>
								<?php } /*END_PHP_SIRFCIT*/ ?>
							</section>
							<section class="media-description">
								<div class="media-description-text">
								...
								<p>
									...
									<br>
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="COMET Standard Terms of Use"){ ?>
									<a href="http://www.meted.ucar.edu/legal.htm" target="_blank">COMET Standard Terms
										of Use</a>
									<?php } /*END_PHP_SIRFCIT*/ ?>
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="COMET Standard Terms of Use - NCU"){ ?>
									<a href="http://www.meted.ucar.edu/legal.htm" target="_blank">COMET Standard Terms
									...
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons BY 4.0 International"){ ?>
									<a href="http://creativecommons.org/licenses/by/4.0/" target="_blank">Creative
										Commons BY 4.0 International</a>
									<?php } /*END_PHP_SIRFCIT*/ ?>
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons Attribution-ShareAlike 3.0 IGO"){ ?>
									<a href="http://creativecommons.org/licenses/by-sa/3.0/igo/"
									...
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons Attribution-ShareAlike 2.5"){ ?>
									<a href="http://creativecommons.org/licenses/by-sa/2.5/" target="_blank">Creative
										Commons Attribution-ShareAlike 2.5</a>
									<?php } /*END_PHP_SIRFCIT*/ ?>
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons Attribution-ShareAlike 2.0"){ ?>
									<a href="http://creativecommons.org/licenses/by-sa/2.0/" target="_blank">Creative
									...
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons Attribution-Noncommercial-Share Alike 2.0 Generic"){ ?>
									<a href="http://creativecommons.org/licenses/by-nc-sa/2.0/" target="_blank">Creative
										Commons Attribution-Noncommercial-Share Alike 2.0 Generic</a>
									<?php } /*END_PHP_SIRFCIT*/ ?>
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons Attribution-Noncommercial 2.0 Generic"){ ?>
									<a href="http://creativecommons.org/licenses/by-nc/2.0/" target="_blank">Creative
										Commons Attribution-Noncommercial 2.0 Generic</a>
									<?php } /*END_PHP_SIRFCIT*/ ?>
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons Attribution 2.0"){ ?>
									<a href="http://creativecommons.org/licenses/by/2.0/" target="_blank">Creative
										Commons Attribution 2.0</a>
									<?php } /*END_PHP_SIRFCIT*/ ?>
									<?php /*START_PHP_SIRFCIT*/ if ($item->copyright_type =="Creative Commons Attribution 2.0 Generic"){ ?>
									<a href="http://creativecommons.org/licenses/by/2.0/" target="_blank">Creative
						...
						<article class="panel panel-default">
							<section class="media-thumbnail">
								...
								<a href="<?php echo $item->path . "/index." . $item->extension; ?>" target="_blank"><img
										src="<?php echo $item->path . "/" . $item->name . ".jpg" ?>"
										alt="<?php echo $item->description; ?>" height="130" /></a> <br />
								<a href="<?php echo $item->path . "/index." . $item->extension; ?>" target="_blank">view
									loop</a>
								<?php } /*END_PHP_SIRFCIT*/ ?>
							</section>
							<section class="media-description">
		...
		<footer id="lesson-footer" class="row">
			<div class="col-md-8">
				<% if (lessonLang === 'ES') { %>
				<p id="lesson-copyright">&copy; <%= copyrightYear %>, <a href="https://www.ucar.edu/">The University
						Corporation for Atmospheric Research</a> - Reservados todos los derechos.</p>
				<% } else if (lessonLang === 'FR') { %>
				<p id="lesson-copyright">&copy; <%= copyrightYear %>, <a href="https://www.ucar.edu/">The University
						Corporation for Atmospheric Research</a> - Tous droits réservés.</p>
				<% } else { %>
				<p id="lesson-copyright">&copy; <%= copyrightYear %>, <a href="https://www.ucar.edu/">The University
						Corporation for Atmospheric Research</a> - All Rights Reserved.</p>
				<% } %>
			</div>
			<div class="col-md-4">
				<% if (lessonLang === 'ES') { %>
